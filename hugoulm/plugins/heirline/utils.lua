...
function darken_color(color, alpha, base)
	base = base or palette().base
	return blend(format_color(color), format_color(base), alpha)
end

function brighten_color(color, alpha, base)
	base = base or palette().text
	return blend(format_color(color), format_color(base), alpha)
end
